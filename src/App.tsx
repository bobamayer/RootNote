      ...
      <main className="flex flex-col items-center justify-start py-8 sm:py-12 px-4">
        <div className="w-full max-w-2xl">
          <div className="text-center mb-8 sm:mb-10">
            <h1 className="text-4xl sm:text-5xl font-serif font-bold text-sienna dark:text-rust mb-2">
              RootNote
            </h1>
            <p className="text-ink/60 dark:text-cream/50 italic text-base sm:text-lg">
